...
const test = async () => {
    ...
    console.log('\n---TEST---')
    console.log('addProduct(mockFailProduct) debe devolver un error por falta de campos requeridos')
    console.log(await productManager.addProduct(mockFailProduct))

    console.log('\n---TEST---')
    console.log('addProduct(mockProduct) debe devolver error de CODE repetido')
    console.log(await productManager.addProduct(mockProduct))
    ...
    console.log('\n---TEST---')
    console.log('deleteProduct(1) debe devolver la lista de productos son el producto con id=1')
